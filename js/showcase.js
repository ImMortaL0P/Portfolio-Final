...
export const showcase = {
  'brush': {
    title: 'Brush',
    full: 'Brush Production — Creative & Design Ecosystem',
    kind: 'B2B & B2C Outlet',
    year: '2026',
    href: 'https://immortal0p.github.io/Brush-Production/',
    stack: ['High-Performance UI', 'E-commerce Architecture', 'Admin Dashboard'],
    lede: 'A comprehensive b2b and b2c outlet for design and creative physical media needs, serving retail customers alongside institutions and corporate clients with ease.',
    hero: 'assets/showcase/brush-hero.webp',
    features: [
      { n: '01', t: 'Product page & intuitive cataloging',
        d: 'Robust product configurations supporting high-volume institutional orders as well as single retail purchases. Detailed specs, pricing variants, and quick-add actions keep checkout flows seamless.',
        shot: 'assets/showcase/brush-product1.webp' },
      { n: '02', t: 'Rich media listing & dynamic store',
        d: 'An immersive store listing showcasing creative physical media. High-quality asset delivery ensures design clarity without impacting page-load performance.',
        shot: 'assets/showcase/brush-listing2.webp' },
      { n: '03', t: 'Comprehensive administrative control',
        d: 'A powerful backend admin panel that gives complete oversight of inventory, b2b contract orders, users, and daily revenue statistics. Real-time updates eliminate the need for manual record-keeping.',
        shot: 'assets/showcase/brush-admin1.webp' },
      { n: '04', t: 'Seamless cart & checkout',
        d: 'Responsive cart and checkout interface built to eliminate friction. Tax, shipping, and bulk discounts update dynamically to assure accurate institutional billing.',
        shot: 'assets/showcase/brush-cart.webp' }
    ],
    gallery: [
      'assets/showcase/brush-hero.webp',
      'assets/showcase/brush-listing1.webp',
      'assets/showcase/brush-listing2.webp',
      'assets/showcase/brush-product1.webp',
      'assets/showcase/brush-product2.webp',
      'assets/showcase/brush-cart.webp',
      'assets/showcase/brush-admin1.webp',
      'assets/showcase/brush-admin2.webp',
      'assets/showcase/brush-admin3.webp',
      'assets/showcase/brush-admin5.webp',
      'assets/showcase/brush-admin7.webp'
    ]
  },
